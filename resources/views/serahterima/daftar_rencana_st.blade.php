...
<style>
    ...
    .filter-layout {
        display: grid;
        grid-template-columns: minmax(320px, 1.35fr) minmax(230px, 0.95fr) minmax(245px, 0.95fr) 170px;
        gap: 20px 28px;
        align-items: start;
    ...
    .management-check input[type="checkbox"] {
        appearance: none;
        -webkit-appearance: none;
        position: relative;
        width: 19px;
    ...
    .management-check input[type="checkbox"]:checked {
        border-color: var(--st-orange);
        background: var(--st-orange);
        box-shadow: 0 0 0 3px rgba(255, 118, 0, 0.10);
    }

    .management-check input[type="checkbox"]:checked::after {
        position: absolute;
        top: 1px;
        left: 5px;
        width: 6px;
    ...
    .input-suffix-group .field-control {
        border-radius: 9px 0 0 9px;
    }
    ...
    .rencana-st-page #loading-info i {
        margin-right: 6px;
        color: var(--st-orange);
    }
    ...
    @media (max-width: 1290px) {
        .filter-layout {
            grid-template-columns: minmax(300px, 1.3fr) minmax(210px, 0.9fr) minmax(230px, 0.9fr) 150px;
            gap: 18px;
        }
    ...
    .rencana-st-page .page-heading-icon {
        background: linear-gradient(135deg, #2563eb, #1d4ed8);
        box-shadow: 0 10px 20px rgba(37, 99, 235, 0.25);
    }

    .rencana-st-page .page-hero-art {
        color: rgba(37, 99, 235, 0.24);
    }

    .rencana-st-page .summary-icon.orange,
    .rencana-st-page .summary-icon.blue {
        color: #2563eb;
        background: #dbeafe;
    }

    .rencana-st-page .summary-icon.green {
        color: #16a34a;
        background: #f2fbf5;
    }

    .rencana-st-page .summary-icon.amber {
        color: #d97706;
        background: #fffbeb;
    }

    .rencana-st-page .filter-card {
        border-left-color: #2563eb !important;
    }

    .rencana-st-page .filter-card-header i {
        color: #2563eb;
    }

    .rencana-st-page .field-control,
    .rencana-st-page .lookup-display {
        color: #0f172a;
        border-color: #d1d5db;
        background: #fbfdff;
    }

    .rencana-st-page .field-control:focus {
        border-color: #2563eb;
        background: #ffffff;
        box-shadow: 0 0 0 4px rgba(37, 99, 235, 0.12);
    }

    .rencana-st-page .lookup-button {
        color: #2563eb;
        border-color: #d1d5db;
        background: #f8fafc;
    }

    .rencana-st-page .lookup-button:hover,
    .rencana-st-page .lookup-button:focus {
        color: #1d4ed8;
        border-color: #2563eb;
        background: #dbeafe;
        outline: 0;
    ...
    .rencana-st-page .choice-pill input[type="radio"]:checked {
        border-color: #2563eb;
        background: #2563eb;
        box-shadow:
    ...
    .rencana-st-page .management-check input[type="checkbox"]:checked {
        border-color: #2563eb;
        background: #2563eb;
        box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.12);
    }

    .rencana-st-page .action-button {
        border: 1px solid transparent;
        border-radius: 8px;
    }

    .rencana-st-page .view-button {
        color: #ffffff;
        background: #2563eb;
        box-shadow: 0 5px 12px rgba(37, 99, 235, 0.22);
    }

    .rencana-st-page .view-button:hover,
    .rencana-st-page .view-button:focus {
        color: #ffffff;
        background: #1d4ed8;
    }

    .rencana-st-page .excel-button {
        color: #16a34a;
        border-color: #bbdec8;
        background: #f2fbf5;
        box-shadow: none;
    ...
    .rencana-st-page .action-button svg {
        width: 17px;
        height: 17px;
        flex: 0 0 17px;
        fill: none;
    ...
    .rencana-st-page button,
    .rencana-st-page textarea,
    .rencana-st-page label,
    .rencana-st-page table,
    .rencana-st-page td,
    .rencana-st-page .page-heading p {
        font-family: "Segoe UI", Tahoma, Arial, sans-serif !important;
    }

    .rencana-st-page .page-heading h1,
    .rencana-st-page .filter-label,
    .rencana-st-page .summary-label,
    .rencana-st-page .report-table th,
    .rencana-st-page .modal-header h5 {
    ...
    .rencana-st-page .report-wrapper::before {
        content: "";
        position: absolute;
        top: 0;
        left: 7%;
    ...
    .rencana-st-page .report-company {
        color: #1d4ed8;
        font-size: 11px;
        font-weight: 850;
    ...
    .rencana-st-page .report-subtitle-label {
        justify-self: start;
        color: #667085;
        white-space: nowrap;
    }

    .rencana-st-page .report-subtitle-value {
        justify-self: center;
        color: #344054;
        font-weight: 850;
        text-align: center;
    ...
    .rencana-st-page .report-subtitle strong {
        color: #344054;
        font-weight: 850;
    }

    .rencana-st-page .report-live-badge {
        display: inline-flex;
        flex: 0 0 auto;
        justify-self: end;
        align-items: center;
    ...
    .rencana-st-page .report-live-badge::before {
        content: "";
        width: 6px;
        height: 6px;
        border-radius: 50%;
    ...
    .rencana-st-page .report-table-container::-webkit-scrollbar {
        width: 11px;
        height: 13px;
    }

    .rencana-st-page .report-table-container::-webkit-scrollbar-track {
        border-radius: 999px;
        background: #eff3f7;
    }

    .rencana-st-page .report-table-container::-webkit-scrollbar-thumb {
        border: 2px solid #eff3f7;
        border-radius: 999px;
        background: #93c5fd;
    }

    .rencana-st-page .report-table-container::-webkit-scrollbar-thumb:hover {
        background: #60a5fa;
    }

    .rencana-st-page .report-table {
    ...
    .rencana-st-page .report-table td {
        height: 46px;
        padding: 8px 9px !important;
        color: #344054 !important;
        border-top: 0 !important;
    ...
    .rencana-st-page .report-table tbody tr:nth-child(even) td {
        background: #fbfcfe !important;
    }

    .rencana-st-page .report-table tbody tr:hover td {
        background: #f0f7ff !important;
    }

    .rencana-st-page .report-table tbody tr:hover td:first-child {
        color: #1d4ed8 !important;
        box-shadow: inset 4px 0 0 #2563eb !important;
    }

    .rencana-st-page .report-table .empty-row {
...
<div class="rencana-st-page">
    ...
    <section class="modern-card page-hero">
        <div class="page-heading">
            ...
            <div class="page-heading-copy">
                <h1>Daftar Rencana Serah Terima Bangunan</h1>
            </div>
        </div>
    ...
    <section class="summary-grid" aria-label="Ringkasan rencana serah terima">
        <article class="modern-card summary-card">
            <div class="summary-icon orange"><i class="far fa-calendar-alt"></i></div>
            <div class="summary-copy">
                <div class="summary-label">Total Jadwal</div>
                <div class="summary-value" id="stat-total">0</div>
                <div class="summary-caption">Semua rencana ST</div>
            </div>
        </article>
    ...
    <section class="modern-card filter-card">
        ...
        <div class="filter-layout">
            <div class="filter-section">
                ...
                <div class="filter-field">
                    <label class="filter-label" for="blok_awal">Blok/Nomor</label>
                    <div class="block-range">
                        <input type="text" id="blok_awal" class="field-control" value="A" maxlength="30">
                        <span class="range-text">s.d</span>
                        <input type="text" id="blok_akhir" class="field-control" value="ZZ" maxlength="30">
                    </div>
                </div>
            </div>
                        ...
                        @foreach (($jenisList ?? []) as $index => $jenis)
                            <label class="choice-pill">
                                <input
                                    ...
                                    name="jenis"
                                    value="{{ $jenis->KODE }}"
                                    {{ $jenis->KODE === 'NON_KAVLING' ? 'checked' : '' }}
                                >
                                <span>{{ $jenis->DESKRIPSI }}</span>
                            </label>
                        @endforeach
                    </div>
                </div>

                <div class="filter-field conditional-filter-row" id="persentaseBayarRow">
                    <label class="filter-label" for="persentase_bayar">Jml Bayar</label>
                    <div class="input-suffix-group">
                        <input type="number" id="persentase_bayar" class="field-control" value="70" min="0" max="100" step="0.01">
                        <span class="input-suffix">%</span>
                    </div>
                </div>

                <div class="filter-field">
                    <span class="filter-label">Versi Management</span>
                    <label class="management-check">
                        <input type="checkbox" id="versi_management" value="Y">
                        <span>Versi Management</span>
                    </label>
                </div>
...
<script>
    ...
    function bindConditionalFilters() {
        ...
        $('#tgl_awal').on('change', function () {
            if (!$('#tgl_cutoff').val()) {
                $('#tgl_cutoff').val($(this).val());
            }
        });
    }

    function isKavlingSelected() {
        return (
            $('input[name="jenis"]:checked').val() || ''
        ).toUpperCase() === 'KAVLING';
    }

    function syncConditionalFilters() {
        var isKavling = isKavlingSelected();
        var management = $('#versi_management').is(':checked');

        $('#persentaseBayarRow').toggle(isKavling);
        $('#cutoffRow').toggle(management);
        ...
        $('#versi_management')
            .closest('.management-check')
            .toggleClass('is-selected', management);

        $('#stat-management').text(management ? '1' : '0');
        $('#stat-management-caption').text(
            management ? 'Aktif' : 'Tidak aktif'
        );

        if (management && !$('#tgl_cutoff').val()) {
            $('#tgl_cutoff').val($('#tgl_awal').val());
        }
    }
    ...
    function insertModal(title, content) {
        ...
        finalContent += ' id="modalSearchInput"';
        finalContent += ' class="field-control"';
        finalContent += ' placeholder="Cari kode atau nama sektor..."';
        finalContent += ' autocomplete="off"';
        finalContent += ' onkeyup="filterModalTable(this.value)"';
        finalContent += '>';
        finalContent += '</div>';

        finalContent += '<div class="modal-table-wrapper">';
    ...
    function filterModalTable(keyword) {
        ...
        $('#rencanaSTModal .modal-table tbody tr')
            .each(function () {
                var rowText =
    ...
    function getSektorModal() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                html += '<tr';
                html += ' onclick="addSektor(\'*\', \'Semua Sektor\')"';
                html += '>';
                html += '<td>*</td>';
                ...
                $.each(rows, function (index, item) {
                    ...
                    var kdPerusahaan =
                        item.KD_PERUSAHAAN !== undefined &&
                        item.KD_PERUSAHAAN !== null
                            ? item.KD_PERUSAHAAN
                            : (
                                item.kd_perusahaan !== undefined &&
                                item.kd_perusahaan !== null
                    ...
                    html += '<tr';
                    html += ' onclick="addSektor(\'';
                    html += escapeJs(kode);
                    html += '\', \'';
                    html += escapeJs(deskripsi);
                    html += '\')"';
                    html += '>';
                ...
                if (rows.length < 1) {
                    ...
                    html += 'Data sektor untuk unit ';
                    html += '<strong>' +
                        escapeHtml(perusahaan) +
    ...
    function collectUnitTextCandidates() {
        ...
        $('input, textarea').not('.rencana-st-page, script, style, noscript').each(function () {
            push($(this).val());
        });

        $('[title]').not('.rencana-st-page, script, style, noscript').each(function () {
        ...
        for (var index = 0; index < headerSelectors.length; index++) {
            $(headerSelectors[index]).each(function () {
                ...
                $clone.find('.rencana-st-page, script, style, noscript').remove();
                push($clone.text());
            });
        }
    ...
    function getFilterData() {
        var isKavling = isKavlingSelected();
        var management =
            $('#versi_management').is(':checked') ? 'Y' : 'T';
    ...
    function validateFilter() {
        if (!$('#tgl_awal').val() || !$('#tgl_akhir').val()) {
            alert('Periode tanggal rencana serah terima harus diisi.');
            return false;
        }
        ...
        if (!$('#blok_awal').val() || !$('#blok_akhir').val()) {
            alert('Rentang Blok/Nomor harus diisi.');
            return false;
        }

        if (isKavlingSelected()) {
            var persen = parseFloat(
                $('#persentase_bayar').val()
            );
            ...
            if (
                ...
                alert(
                    'Jml Bayar harus berada antara 0 sampai 100 persen.'
                );
                return false;
            }
        ...
        if (
            ...
            alert(
                'Tanggal Cut Off wajib diisi ketika Versi Management dicentang.'
            );
            return false;
        }
    ...
    function getAjaxErrorMessage(xhr, textStatus, errorThrown) {
        var message = 'Gagal mengambil data rencana serah terima.';
        var detail = '';
    ...
    function getSummary() {
        ...
        $.ajax({
            ...
            error: function (xhr, textStatus, errorThrown) {
                ...
                var message = getAjaxErrorMessage(
                    xhr,
                    textStatus,
                    errorThrown
                );
    ...
    function updateDashboardStats(rows) {
        ...
        var realizedPercent = total > 0
            ? ((realized / total) * 100).toFixed(2)
            : '0.00';
        var pendingPercent = total > 0
    ...
    function renderReport(data) {
        ...
        var periode = formatDateIndo($('#tgl_awal').val()) +
            ' s.d ' + formatDateIndo($('#tgl_akhir').val());
        var blokAwal = String($('#blok_awal').val() || 'A').toUpperCase();
        var blokAkhir = String($('#blok_akhir').val() || 'ZZ').toUpperCase();
        var sektorText = $.trim($('#sektorentry').text()) || 'Semua Sektor';
        var jenisText = $.trim(
            $('input[name="jenis"]:checked').next('span').text()
        );
        var isKavling = isKavlingSelected();
        var management = $('#versi_management').is(':checked');
        var persentaseBayar = $('#persentase_bayar').val() || '70';
        var tanggalCutoff = $('#tgl_cutoff').val();
        ...
        html += isKavling
            ? 'DAFTAR RENCANA SERAH TERIMA KAVLING'
            : 'DAFTAR RENCANA SERAH TERIMA BANGUNAN';
        html += '</div>';

        html += '<div class="report-period">';
        html += 'Tanggal Rencana Serah Terima: ' + escapeHtml(periode);
        html += '<br>Blok: ' + escapeHtml(blokAwal) + ' s.d ' + escapeHtml(blokAkhir);
        html += '<br>Jenis: ' + escapeHtml(jenisText);
        html += '<br>Tgl: ' + escapeHtml(formatDateIndo(new Date()));

        if (management) {
            html += '<br>Versi Management | Cut Off: ' +
                escapeHtml(formatDateIndo(tanggalCutoff));
        }

        if (isKavling) {
            html += '<br>Persentase Pembayaran Minimum: ' +
                escapeHtml(persentaseBayar) + ' %';
        }
        ...
        if (rows.length < 1) {
            ...
            $.each(rows, function (index, item) {
                ...
                var telepon = valueOrDash(item.TELP_RMH || item.telp_rmh);
                var blokNomor = item.BLOK_NOMOR || item.blok_nomor;
                var nama = item.NAMA || item.nama;
                var noPpjb = item.NO_PPJB || item.no_ppjb;
                var tglPpjb = item.TGL_PPJB || item.tgl_ppjb;
                var tglRencana = item.TGL_RENCANA_SS || item.tgl_rencana_ss;
                var noSurat = item.NO_SURAT || item.no_surat;
                var tglSurat = item.TGL_SURAT || item.tgl_surat;
                var tglSerahTerima =
                ...
                html += '<td class="multiline-cell">' +
                    escapeHtml(valueOrDash(noPpjb)) + '<br>' +
                    formatDateIndo(tglPpjb) + '</td>';
                html += '<td>' + formatDateIndo(tglRencana) + '</td>';
                html += '<td class="multiline-cell">' +
                    escapeHtml(valueOrDash(noSurat)) + '<br>' +
                    formatDateIndo(tglSurat) + '</td>';
                html += '<td>' + formatDateIndo(tglSerahTerima) + '</td>';
                html += '<td class="address-cell">' +
                    escapeHtml(alamat).replace(/\n/g, '<br>');
    ...
    function printRencanaSTReport() {
        ...
        frame.id = 'rencanaSTNativePrintFrame';
        ...
        frameDocument.write(
            ...
            + '<title>Daftar Rencana Serah Terima</title>'
        ...
        window.setTimeout(function () {
            try {
                ...
                console.error('Gagal membuka dialog print Rencana ST:', error);
                cleanupPrintFrame();
